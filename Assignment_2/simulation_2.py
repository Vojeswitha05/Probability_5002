...
Original file is located at
    https://colab.research.google.com/drive/11aMGcCMdueVvGuu21eBryoigMAN2XhvH
"""
...
plt.stem(x + 0.00, prob_T, markerfmt='o',use_line_collection=True, basefmt=None , linefmt='blue' ,label='Theoritical')
plt.stem(x + 0.25, prob_S, markerfmt='o', use_line_collection=True, basefmt=None  ,linefmt='yellow', label='Simulated')
plt.title('Theoritical vs simulated')
plt.xlabel('cases')
